...
export const ProductAdditionalAttributesSection = ({
  ...
  // No attributes have been defined for this product (none global, none for its
  // category), so there is nothing to display or edit. Hide the section entirely
  // rather than showing an empty header with an Edit action that opens a blank
  // drawer. It reappears automatically once an admin defines applicable attributes.
